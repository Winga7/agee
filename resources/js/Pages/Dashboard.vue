...
function updateStats() {
  router.get(
    "/dashboard",
    {
      ...
      module_id: selectedModule.value === "all" ? null : selectedModule.value,
    },
    {
      preserveState: true,
      preserveScroll: true,
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-5">
                <div class="text-gray-400">Évaluations Complétées</div>
                <div class="text-2xl font-semibold">
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <div class="flex items-center">
              ...
              <div class="ml-5">
                <div class="text-gray-400">Taux de Participation</div>
                <div class="text-2xl font-semibold">
