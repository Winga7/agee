...
<template>
    <AppLayout title="Gestion des étudiants">
                                ...
                                <tr v-for="student in students" :key="student.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex space-x-2">
                                            ...
                                            <button @click="manageEnrollments(student)"
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submitForm">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <InputLabel for="student_number" value="Numéro étudiant" />
                            <TextInput id="student_number" v-model="form.student_number" type="text" class="mt-1 block w-full" required />
                        ...
                        <div>
                            ...
                            <TextInput id="phone_number" v-model="form.phone_number" type="tel" class="mt-1 block w-full" />
                    ...
                    <div class="flex justify-end mt-6 space-x-2">
                        ...
                        <PrimaryButton type="submit" :disabled="form.processing">
                            {{ form.processing ? "Enregistrement..." : (isEditing ? "Modifier" : "Ajouter") }}
                        </PrimaryButton>
                    </div>
                </form>
            </div>
        ...
        <Modal :show="showEnrollmentModal" @close="showEnrollmentModal = false">
            <div class="p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">
                    Gérer les inscriptions - {{ selectedStudent?.first_name }} {{ selectedStudent?.last_name }}
                </h3>
                ...
                <form @submit.prevent="submitEnrollment">
                    <div class="space-y-4">
                        <div>
                            ...
                            <select v-model="enrollmentForm.module_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <select v-model="enrollmentForm.class_group" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                <option value="">Sélectionner une classe</option>
                                <option v-for="group in classGroups" :key="group" :value="group">
                                    {{ group }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <TextInput type="date" v-model="enrollmentForm.start_date" class="mt-1 block w-full" />
                            </div>
                            <div>
                                <InputLabel value="Date de fin" />
                                <TextInput type="date" v-model="enrollmentForm.end_date" class="mt-1 block w-full" />
                            </div>
                        </div>
                    </div>
