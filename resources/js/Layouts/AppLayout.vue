              ...
              >
                ...
                <div class="flex items-center h-full">
                  <Dropdown align="left" width="48">
                    <template #trigger>
                      <button
                        class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium hover:text-indigo-600 -my-px"
                        :class="{
                          'text-indigo-600': isManagementActive,
                        }"
                      >
                        Gestion
                        <svg
                    ...
                    <template #content>
                      <DropdownLink
                        ...
                        :class="{
                          'bg-indigo-50': route().current('students.index'),
                        }"
                      ...
                      <DropdownLink
                        ...
                        :class="{
                          'bg-indigo-50': route().current('modules.index'),
                        }"
                        class="hover:bg-gray-100"
                      >
                        Gestion des Modules
                      ...
                      <DropdownLink
                        ...
                        :class="{
                          'bg-indigo-50': route().current('classes.index'),
                        }"
                        class="hover:bg-gray-100"
                      >
                        Gestion des Classes
